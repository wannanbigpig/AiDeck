...
const services = {
  ...
  codex: {
    ...
    startExportCliSessionsArchiveTask: function (options) { return codexService.startExportCliSessionsArchiveTask(options || {}) },
    listExportCliSessionsArchiveTasks: function (options) { return codexService.listExportCliSessionsArchiveTasks(options || {}) },
    getExportCliSessionsArchiveTask: function (options) { return codexService.getExportCliSessionsArchiveTask(options || {}) },
    readExportCliSessionsArchive: function (options) { return codexService.readExportCliSessionsArchive(options || {}) },
    deleteExportCliSessionsArchiveTask: function (options) { return codexService.deleteExportCliSessionsArchiveTask(options || {}) },
    exportCliSessionsArchive: function (options) { return codexService.exportCliSessionsArchive(options || {}) },
    importCliSessionsArchive: function (options) { return codexService.importCliSessionsArchive(options || {}) },
    copyCliSessionToInstance: function (options) { return codexService.copyCliSessionToInstance(options || {}) },
    moveCliSessionToInstance: function (options) { return codexService.moveCliSessionToInstance(options || {}) },
    archiveCliSession: function (options) { return codexService.archiveCliSession(options || {}) },
    unarchiveCliSession: function (options) { return codexService.unarchiveCliSession(options || {}) },
    moveCliSessionsToTrash: function (options) { return codexService.moveCliSessionsToTrash(options || {}) },
    listCliSessionTrash: function (options) { return codexService.listCliSessionTrash(options || {}) },
    restoreCliSessionFromTrash: function (options) { return codexService.restoreCliSessionFromTrash(options || {}) },
    restoreCliSessionsFromTrash: function (options) { return codexService.restoreCliSessionsFromTrash(options || {}) },
    ...
    deleteWakeupSchedule: function (id) { return codexService.deleteWakeupSchedule(id) },
    runWakeupSchedule: function (id, options) { return codexService.runWakeupSchedule(id, options) },
